...
public class EcgDrawingGraphView extends View{
    ...
    public EcgDrawingGraphView(Context context) {
        super(context);
        init(context, null);
    }

    public EcgDrawingGraphView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EcgDrawingGraphView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public EcgDrawingGraphView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
