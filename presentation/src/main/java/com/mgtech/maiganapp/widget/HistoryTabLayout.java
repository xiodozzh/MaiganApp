...
public class HistoryTabLayout extends LinearLayout {
    ...
    public HistoryTabLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HistoryTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        setOrientation(HORIZONTAL);
        inflate(context, R.layout.layout_history_tab, this);
