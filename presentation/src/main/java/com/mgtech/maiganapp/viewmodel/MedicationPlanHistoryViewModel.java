 ...
 * @author zhaixiang
 */
public class MedicationPlanHistoryViewModel extends BaseViewModel {
    ...
    public MedicationPlanHistoryViewModel(@NonNull Application application) {
        super(application);
    ...
    public void getMedicationPlan(){
        loading.set(true);
        dataList.clear();
        useCase.getCompletedMedicationPlanList(SaveUtils.getUserId(getApplication()),new Subscriber<NetResponseEntity<List<MedicationPlanEntity>>>() {
            @Override
                ...
                if (listNetResponseEntity.getCode() == 0){
                    ...
                    if (entities != null && !entities.isEmpty()) {
                        ...
                        for (MedicationPlanEntity entity : entities) {
                            dataList.add(MedicationPlanModelWrapper.getModelFromMedicationPlanEntity(entity,true));
                        }
                    }
